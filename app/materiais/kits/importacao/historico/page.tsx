...
export default async function MaterialKitImportHistoryPage() {
    ...
    <main className="mx-auto max-w-7xl space-y-8 px-4 py-6 sm:p-8">
      <div className="flex flex-col gap-4">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-bold tracking-tight">Histórico de importações de kits</h1>
            <p className="text-muted-foreground">
              Rastreabilidade dos lotes processados, com resumo das revisões criadas, atualizadas ou
